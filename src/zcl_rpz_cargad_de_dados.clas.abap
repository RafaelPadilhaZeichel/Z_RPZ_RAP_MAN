CLASS zcl_rpz_cargad_de_dados DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rpz_cargad_de_dados IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    TYPES: tt_product  TYPE TABLE OF ztrpz_product WITH DEFAULT KEY,
           tt_vendor   TYPE TABLE OF ztrpz_vendor WITH DEFAULT KEY,
           tt_company  TYPE TABLE OF ztrpz_company WITH DEFAULT KEY,
           tt_customer TYPE TABLE OF ztrpz_customer WITH DEFAULT KEY.
    ...
    DELETE FROM ztrpz_product.
    DELETE FROM ztrpz_vendor.
    DELETE FROM ztrpz_company.
    DELETE FROM ztrpz_customer.

    MODIFY ztrpz_product FROM TABLE @lt_product.
    MODIFY ztrpz_vendor FROM TABLE @lt_vendor.
    MODIFY ztrpz_company FROM TABLE @lt_company.
    MODIFY ztrpz_customer FROM TABLE @lt_customer.
